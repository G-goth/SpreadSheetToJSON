...
let methodNames: string[] = ["DownloadJsonFileActiveSheet", "DownloadJsonFileAllSheet", "DownloadJsonFileSheetAllinOne"];
...
function onOpen() {
    ...
    menu.addItem("すべてのシートをJSONに出力(1ファイル)", methodNames[1]);
